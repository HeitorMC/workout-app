...
RSpec.describe '/workouts', type: :request do
  describe 'GET /index' do
    ...
    before { get workouts_url, headers: }
  ...
  describe 'GET /show' do
    ...
    before { get workout_url(workouts.last.id), headers: }
  ...
  describe 'GET /new' do
    ...
    before { get new_workout_url, headers: }
  ...
  describe 'GET /edit' do
    ...
    before { get edit_exercise_url(workouts.last.id), headers: }
  ...
  describe 'POST /create' do
    context 'when the parameters are valid' do
      ...
      it 'creates a new Workout' do
        expect { post workouts_url(valid_attributes), headers: }.to change(Workout, :count).by(1)
      end

      it 'redirects to the created workout' do
        post workouts_url(valid_attributes), headers: headers
    ...
    context 'when the parameters are invalid' do
      ...
      it 'does not create a new Workout' do
        expect { post workouts_url(invalid_attributes), headers: }.to change(Workout, :count).by(0)
      end

      it 'renders unprocessable entity response' do
        post workouts_url(invalid_attributes), headers: headers
  ...
  describe 'PATCH /update' do
    context 'when the parameters are valid' do
      ...
      before { patch workout_url(workout.id, valid_attributes), headers: }
    ...
    context 'when the parameters are invalid' do
      ...
      before { patch workout_url(workout.id, invalid_attributes), headers: }
  ...
  describe 'DELETE /destroy' do
    ...
    it 'destroys the requested workout' do
      expect { delete workout_url(workout.id), headers: }.to change(Workout, :count).by(-1)
    end

    it 'redirects to the workouts list' do
      delete workout_url(workout.id), headers: headers
